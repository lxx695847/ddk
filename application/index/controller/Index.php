...
class Index extends Controllers
{
    ...
    public function paid(){
        ...
        $jssdk = new Jssdk("wxf75d5ca0daa9be82", "b1a2817a7899ed0301a014c8a1421ae7");
    ...
    public function findOne(){
        ...
        if(isset($data) && !empty($data)){
            ...
            $sign = Rsas::getInstance()->encode($post['mobile']);
            return $this->renderSuccess('',['redirect'=>'/index/index/del?sign='.$sign]);
        }
    }
