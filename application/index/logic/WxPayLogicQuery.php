    ...
    public function alpay($params = null)
    {
        ...
        try {
            ...
            $wap_config = [
                ...
                'private_key_path' => '/www/wwwroot/www.ddk.com/extend/alipaywap/key/rsa_private_key.pem',
                //支付宝公钥（后缀是.pen）文件相对路径
                'ali_public_key_path' => '/www/wwwroot/www.ddk.com/extend/alipaywap/key/alipay_public_key.pem',
                //签名方式
    ...
    public function order($params = null)
    {
        ...
        try {
            ...
            $data = [
                ...
                'price' => $price['price'],
                'commission' => DigitalHelper::mul($price['price'], DigitalHelper::div($authAgent['rebate'], 100, 2), 2), //二级提成
