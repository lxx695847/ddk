...
class Assistant extends HelperClass {
                ...
                while (false !== ($item = readdir($handle))) {
                    if ($item != '.' && $item != '..') {
                        if (is_dir($dir_name . DS . $item)) {
                            self::delete_dir_file($dir_name . DS . $item);
                        } else {
     ...
     * @return bool
     */
    public static function check_mobile_number($mobile)
    {
     ...
     */
    public static function get_auth_token($name,$phone,$idcard){
     ...
     * 请求方式：GET
     */
    public static function crawler($token){
        $appId = 'gxb75264a1586e93efb';
        $appSecret = '8bbde44d96924262974c02ad77643881';
