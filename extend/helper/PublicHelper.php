...
class PublicHelper extends HelperClass{
    ...
    public static function number(){
        $str = date('Ymd').substr(implode(NULL, array_map('ord', str_split(substr(uniqid(), 7, 13), 1))), 0, 10);
        return $str;
    }
     ...
     * @return string
     */
    public static function numberOrder()
    {
     ...
     */
    public static function validateEmpty($str, $name) {
        if (empty($str)) {
     ...
     * @return JS
     */
    public static function validateAll($str1, $str2, $alert) {
     ...
     * @param int $image_id
     */
    public static function delPicByImageId($image_id) {
