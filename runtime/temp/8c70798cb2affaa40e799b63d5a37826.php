<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"./views/index/shangping/confirmorder.html";i:1578453274;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	...
	<section class="aui-settle-content">
		...
		<div class="aui-settle-choice">
			<a href="#" class="aui-address-cell  aui-fl-arrow-clear">
				<div class="aui-address-cell-hd">
					<img src="/public/themes/img/icon/apy-1.png" alt="">
				</div>
			...
			<a href="#" class="aui-address-cell  aui-fl-arrow-clear">
				<div class="aui-address-cell-hd">
					<img src="/public/themes/img/icon/apy-2.png" alt="">
				</div>
				<div class="aui-address-cell-bd">
					农业银行
					<p>储蓄卡（5678）</p>
			...
			<a href="#" class="aui-address-cell  aui-fl-arrow-clear">
				<div class="aui-address-cell-hd">
					<img src="/public/themes/img/icon/apy-3.png" alt="">
				</div>
				<div class="aui-address-cell-bd">
					招商银行
					<p>储蓄卡（8890）</p>
		...
		<div class="aui-settle-choice">
			<a href="#" class="aui-address-cell  aui-fl-arrow-clear">
				<div class="aui-address-cell-hd">
					<img src="/public/themes/img/icon/apy-4.png" alt="">
				</div>
				<div class="aui-address-cell-bd">
					支付宝支付
					<p>支付宝安全支付</p>
