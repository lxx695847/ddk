<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:35:"./views/index/shangping/detail.html";i:1578453274;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<meta charset="UTF-8">
	<title>商品详情</title>
	<link rel="stylesheet" href="/public/themes/css/core.css">
	<link rel="stylesheet" href="/public/themes/css/icon.css">
	<link rel="stylesheet" href="/public/themes/css/home.css">
...
<body>
	...
	<div class="aui-banner-content aui-fixed-top" data-aui-slider>
		<div class="aui-banner-wrapper">
			<div class="aui-banner-wrapper-item">
				<a href="#">
					<img src="/public/themes/img/pd/<?php  echo $_GET['url']; ?>">
				</a>
			</div>
			<div class="aui-banner-wrapper-item">
				<a href="#">
	...
	<div class="aui-product-content">
		<div class="aui-real-price clearfix">
			<span>
				<i>￥</i><?php  echo $_GET['price']; ?>
			</span>
			<del><span class="aui-font-num">￥<?php  echo $_GET['price']+10; ?></span></del>
		...
		<div class="aui-product-boutique clearfix">
			<img src="/public/themes/img/icon/icon-usa.png" alt="">
			<span class="aui-product-tag-text">美国品牌</span>
			<img src="/public/themes/img/icon/icon-sj.png" alt="">
				...
				<div style="position:relative">
					<div class="aui-spec-menu-top">
						<div class="aui-spec-first-pic">
							<img src="/public/themes/img/pd/pd-zf-1.jpg" alt="">
						</div>
			...
			<div class="m-actionsheet" id="J_ActionSheet">
				<div class="aui-coupon-codes">
					...
					<div class="aui-coupon-codes-item">
						<img src="/public/themes/img/icon/icon-coupon1.jpg" alt="">
					</div>
					<div class="aui-coupon-codes-item">
						<img src="/public/themes/img/icon/icon-coupon1.jpg" alt="">
					</div>
				...
				<div class="aui-address-cell-bd">
					<div class="clearfix">
						<div class="aui-product-shop-img">
							<img src="/public/themes/img/user/user10.png" alt="">
						</div>
			...
			<div class="aui-slide-list">
				<ul class="aui-slide-item-list">
					<li class="aui-slide-item-item">
						<a href="#" class="v-link">
							<img class="v-img" src="/public/themes/img/pd/sf-1.jpg">
					...
					<li class="aui-slide-item-item">
						<a href="#" class="v-link">
							<img class="v-img" src="/public/themes/img/pd/sf-2.jpg">
					...
					<li class="aui-slide-item-item">
						<a href="#" class="v-link">
							<img class="v-img" src="/public/themes/img/pd/sf-3.jpg">
					...
					<li class="aui-slide-item-item">
						<a href="#" class="v-link">
							<img class="v-img" src="/public/themes/img/pd/sf-4.jpg">
					...
					<li class="aui-slide-item-item">
						<a href="#" class="v-link">
							<img class="v-img" src="/public/themes/img/pd/sf-5.jpg">
					...
					<li class="aui-slide-item-item">
						<a href="#" class="v-link">
							<img class="v-img" src="/public/themes/img/pd/sf-6.jpg">
					...
					<li class="aui-slide-item-item">
						<a href="#" class="v-link">
							<img class="v-img" src="/public/themes/img/pd/sf-7.jpg">
		...
		<div class="aui-product-pages">
			...
			<div class="aui-product-pages-img">
				<img src="/public/themes/img/pd/pd-cp0.jpg" alt="">
				<img src="/public/themes/img/pd/pd-cp2.jpg" alt="">
				<img src="/public/themes/img/pd/pd-cp3.jpg" alt="">
				<img src="/public/themes/img/pd/pd-cp1.jpg" alt="">
				<img src="/public/themes/img/pd/pd-cp.jpg" alt="">
				<img src="/public/themes/img/pd/pd-cp4.jpg" alt="">
	...
	<footer class="aui-footer-product">
		<div class="aui-footer-product-fixed">
			<div class="aui-footer-product-concern-cart">
				<a href="#">
					<span class="aui-f-p-icon"><img src="/public/themes/img/icon/icon-kf.png" alt=""></span>
					<span class="aui-f-p-focus-info">客服</span>
				</a>
				<a href="#">
					<span class="aui-f-p-icon"><img src="/public/themes/img/icon/icon-sc.png" alt=""></span>
					<span class="aui-f-p-focus-info">收藏</span>
				</a>
				<a href="#">
					<span class="aui-f-p-icon"><img src="/public/themes/img/icon/icon-dp.png" alt=""></span>
					<span class="aui-f-p-focus-info">店铺</span>
				</a>
			</div>
			<div class="aui-footer-product-action-list">
				<a href="<?php echo url('/index/Shangping/car'); ?>" class="yellow-color">加入购物车</a>
				<a href="<?php echo url('/index/Shangping/order'); ?>" class="red-color">立即购买</a>
			</div>
		</div>
	</footer>

	<script src="/public/themes/js/jquery.min.js"></script>
	<script src="/public/themes/js/aui.js"></script>
	<script src="/public/themes/js/aui-down.js"></script>
	<script type="text/javascript" src="/public/themes/js/city.js"></script>
