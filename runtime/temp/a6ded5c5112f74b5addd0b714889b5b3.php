<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:30:"./views/admin/fault/index.html";i:1578453294;s:46:"/www/wwwroot/www.ddk.com/views/admin/base.html";i:1578453289;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form layui-form-pane" id="myform" action="<?php echo url('backend/fault/index'); ?>" method="get">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td style="text-align:center; width:15%">
                            <a href="https://www.baidu.com/s?wd=<?php echo $vo['title']; ?>" target="_blank" class="layui-btn layui-btn-xs layui-btn-normal">百度一下</a>
                            <a href="<?php echo url('backend/company/add',['name'=>$vo['title']]); ?>" class="layui-btn layui-btn-xs">添加公司</a>
