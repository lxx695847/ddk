<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"./views/admin/authagent/index.html";i:1578453297;s:46:"/www/wwwroot/www.ddk.com/views/admin/base.html";i:1578453289;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <form class="layui-form layui-form-pane" action="<?php echo url('backend/authagent/index'); ?>" method="get">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo intval($vo['rebate']); ?>%</td>
                        <td><?php echo intval($vo['erjiprice']); ?>%</td>
                        <td><?php echo $vo['price'] * ($vo['rebate']/100); ?></td>
                        <td><?php echo $vo['price'] * ($vo['erjiprice']/100); ?></td>
                        <td><?php echo $vo['highestprice']; ?></td>
                        <td>
                            <a href="<?php echo url('backend/authagent/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                            <a href="<?php echo url('backend/authagent/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
