<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:28:"./views/admin/link/edit.html";i:1578453293;s:46:"/www/wwwroot/www.ddk.com/views/admin/base.html";i:1578453289;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('backend/Link/index'); ?>">提现管理</a></li>
                ...
                <form class="layui-form form-container" id="myForm" method="post">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="price" value="<?php echo $list['price']; ?>" required lay-verify="required" placeholder="请输入定义查询价格" class="layui-input">
                        </div>
                    </div>

                    <?php if($list['product_type'] == 2): ?>
                    <div class="layui-form-item">
                        <label class="layui-form-label">热门问题价格</label>
                        <div class="layui-input-block">
                            <input type="text" name="price1" value="<?php echo $list['price1']; ?>" required lay-verify="required" placeholder="请输入热门问题价格" class="layui-input">
                        </div>
                    </div>
                    <?php endif; ?>

                    <input type="hidden" name="type" value="<?php echo $list['product_type']; ?>">
