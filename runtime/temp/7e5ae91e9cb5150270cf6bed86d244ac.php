<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:32:"./views/admin/product/index.html";i:1578453291;s:46:"/www/wwwroot/www.ddk.com/views/admin/base.html";i:1578453289;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <form class="layui-form layui-form-pane" action="<?php echo url('backend/product/index'); ?>" method="get">
                ...
                <table class="layui-table">
                    ...
                    <tr>
						...
						<td><?php if(isset($vo['thumb']) && !empty($vo['thumb'])): ?><img style="height:50px; width:50px;" src="<?php echo $vo['thumb']; ?>"/><?php endif; ?></td>
                        ...
                        <td>
                            ...
                            <a href="<?php echo url('backend/product/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                            <a href="<?php echo url('backend/product/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                </table>
				<div style="float:right; font-size:20px;"> 产品数：<?php echo count($list); ?></div>
                <!--分页-->
