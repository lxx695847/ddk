<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:35:"./views/admin/auth_group/index.html";i:1578453296;s:46:"/www/wwwroot/www.ddk.com/views/admin/base.html";i:1578453289;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            ...
            <li class=""><a href="<?php echo url('backend/auth_group/add'); ?>">添加权限组</a></li>
        </ul>
            ...
            <div class="layui-tab-item layui-show">
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('backend/auth_group/auth',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini">授权</a>
                            <a href="<?php echo url('backend/auth_group/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                            <a href="<?php echo url('backend/auth_group/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
