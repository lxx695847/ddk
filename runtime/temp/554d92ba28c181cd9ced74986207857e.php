<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:29:"./views/admin/link/index.html";i:1578453293;s:46:"/www/wwwroot/www.ddk.com/views/admin/base.html";i:1578453289;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-tab-item layui-show">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td ><a target="_blank" href="<?php echo $vo['url']; ?>">查看链接</a></td>
                        <td><?php echo $vo['price']; ?></td>
                        <td><?php echo $vo['ticheng']; ?></td>
                        <td><?php echo intval($vo['grebate']); ?>%</td>
                        <td><?php echo intval($vo['gerjiprice']); ?>%</td>
                        <td><?php echo date("Y-m-d H:i:s",$vo['createdAt']); ?></td>
                        <td>
                            <a href="<?php echo url('backend/Link/edit'); ?>?sign=<?php echo $vo['sign']; ?>" class="layui-btn layui-btn-normal layui-btn-mini">改价</a>
