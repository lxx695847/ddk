<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:34:"./views/index/shangping/order.html";i:1578453275;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<section class="aui-address-content">
		...
		<div class="aui-list-product-float-item">
			<a href="javascript:;" class="aui-list-product-fl-item">
				<div class="aui-list-product-fl-img">
					<img src="/public/themes/img/pd/sf-10.jpg" alt="">
				</div>
				<div class="aui-list-product-fl-text">
					...
					<div class="aui-list-product-fl-bag">
						<span><img src="/public/themes/img/icon/bag1.png" alt=""></span>
						<span><img src="/public/themes/img/icon/bag2.png" alt=""></span>
					</div>
				</div>
			</a>
		</div>
		...
		<div class="aui-payment-bar">
			...
			<a href="<?php echo url('/index/Shangping/confirmOrder'); ?>" class="settlement">提交订单</a>
		</div>
	</section>
